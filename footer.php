...
$whmcsLogo = '';
$companyName = '<span class="dynamic-brand-name" data-brand="name">Fillsbase</span>';
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-2">
          ...
          <ul class="footer-menu">
            ...
            <li class="menu-item"><a href="/wordpress" title="WordPress Hosting">WordPress Hosting</a></li>
            <li class="menu-item"><a href="/emailsecurity" title="Professional Email">Professional Email</a></li>
            <li class="menu-item"><a href="/domainchecker" title="Domains">Domain Names</a></li>
          </ul>
        </div>
        ...
        <div class="col-sm-6 col-md-2">
          ...
          <ul class="footer-menu">
            <li class="menu-item"><a href="/ecommerce" title="E-commerce">E-commerce</a></li>
            <li class="menu-item"><a href="/wordpress" title="WordPress">WordPress</a></li>
            <li class="menu-item"><a href="/reactdev" title="React / Custom">React / Custom</a></li>
            <li class="menu-item"><a href="/mobileapps" title="Mobile Apps">Mobile Apps</a></li>
            <li class="menu-item"><a href="/saas" title="SaaS">SaaS Dev</a></li>
            <li class="menu-item"><a href="/customsoftware" title="Custom Software">Custom Software</a></li>
          </ul>
        </div>
        ...
        <div class="col-sm-6 col-md-2">
          ...
          <ul class="footer-menu">
            <li class="menu-item"><a href="/seo" title="SEO">SEO &amp; Search</a></li>
            <li class="menu-item"><a href="/digital-marketing" title="Digital Marketing">Digital Marketing</a></li>
            <li class="menu-item"><a href="/google-ads" title="Google Ads">Google Ads</a></li>
            <li class="menu-item"><a href="/smm" title="Social Media">Social Media (SMM)</a></li>
            <li class="menu-item"><a href="/aiagents" title="AI Agents">AI Agents</a></li>
            <li class="menu-item"><a href="/ai-automation" title="AI Automation">AI Automation</a></li>
          </ul>
        </div>
        ...
        <div class="col-sm-6 col-md-2">
          ...
          <ul class="footer-menu">
            <li class="menu-item"><a href="/clientarea.php" title="Client Area">Client Area</a></li>
            <li class="menu-item"><a href="/knowledgebase.php" title="Knowledge Base">Knowledge Base</a></li>
            <li class="menu-item"><a href="/submitticket.php" title="Open a Ticket">Open a Ticket</a></li>
            <li class="menu-item"><a href="/supporttickets.php" title="My Tickets">My Tickets</a></li>
            <li class="menu-item"><a href="/contact" title="Contact">Contact Us</a></li>
            <li class="menu-item"><a href="/announcements.php" title="Announcements">Announcements</a></li>
          </ul>
        </div>

        <!-- Col 5: Logo + About + Socials -->
        <div class="col-sm-6 col-md-4">
          ...
          <ul class="footer-menu" style="margin-top:14px;columns:2;column-gap:16px;">
            <li class="menu-item"><a href="/about" title="About Us">About Us</a></li>
            <li class="menu-item"><a href="/blog-details" title="Blog">Blog</a></li>
            <li class="menu-item"><a href="/legal" title="Legal Notice">Legal Notice</a></li>
            <li class="menu-item"><a href="/promos" title="Promotions">Promotions</a></li>
            <li class="menu-item"><a href="/vpn" title="VPN">VPN Solutions</a></li>
            <li class="menu-item"><a href="/gsuite" title="Google Workspace">Google Workspace</a></li>
          </ul>
        </div>
