...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
  <div class="offcanvas-header">
    <h4 id="offcanvasRightLabel" class="fw-bold mb-0 f-24">Configuration {$companyname}</h4>
  ...
  <div id="container_layout" class="offcanvas-body">
    <a href="https://themeforest.net/item/fillsbase-hosting-provider-whmcs-template/23139614" target="_blank" class="btn btn-default-pink-fill d-grid mb-3">Buy Now on Envato $29</a>
    ...
    <div class="offcanvas-content">
      ...
      <div id="LayoutScheme" class="overflow-hidden">
        <div class="row gy-3">
          ...
          <div class="col-xs-6 col-md-6">
            <div class="p-4 border text-center text-muted bg-light stylelayout active f-16" data-value="wideboxed">Wide Boxed</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="offcanvas-content">
      ...
      <div id="BackgroundScheme" class="overflow-hidden">
        <div class="row gy-3">
          <div class="col-xs-6 col-md-6">
            <div class="p-4 mb-4 border text-center text-muted bg-light stylebackground active f-16" data-value="origin">Origin</div>
          </div>
          <div class="col-xs-6 col-md-6">
    ...
    <div class="offcanvas-content">
      ...
      <div id="ColorScheme" class="overflow-hidden">
        <div class="row gy-3">
          ...
          <div class="col-xs-6 col-md-6">
            <div class="p-4 border text-center text-muted bg-light stylecolor active f-16" data-value="green">Green Mode</div>
          </div>
          <div class="col-xs-6 col-md-6">
