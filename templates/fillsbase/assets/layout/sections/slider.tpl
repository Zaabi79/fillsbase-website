<style>
  .header-main-slider, .header-main-slider .carousel-cell, .carousel-cell.overlay {
...
<div class="main-container slider">
    <div class="silder-container">
        <div class="carousel header-main-slider" style="background: transparent !important;">
            <!-- 1 Slider -->
            <div class="carousel-cell overlay" style="background: transparent !important;">
                ...
                <div class="silder-video">
                    <div class="cover-wrapper">
                        <div class="hero-overlay" style="position: absolute; top: 0; left: 0; width: 60%; height: 100%; background: linear-gradient(to right, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0.3) 50%, transparent 100%); z-index: 2; pointer-events: none;"></div>
                        <video class="cover-video" autoplay loop muted style="z-index: 1; filter: brightness(0.6) contrast(1.1);">
                            <source src="{$WEB_ROOT}/templates/{$template}/assets/videos/server.mp4" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-cell overlay">
                <div class="slider-content">
                    <div class="container ">
                        ...
                        <div class="col-sm-12 col-md-6 px-0">
                            <h1 data-aos="fade-up" data-aos-duration="800">Serveur <br>Dédié avec <br> <span id="typed1"></span></h1>
            ...
            <div class="carousel-cell sec-bg6 bg-colorstyle">
                <div class="slider-content">
                    <div class="container ">
                        ...
                        <div class="col-sm-12 col-md-6 px-0">
                            <h1 class="mergecolor" data-aos="fade-up" data-aos-duration="800">Forfait <br>Hébergement</h1>
