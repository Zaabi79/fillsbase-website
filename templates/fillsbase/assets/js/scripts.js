/*------------------------------------------------------------------
Project: Logic Web – Hébergement Web et Services IT en Africa
Description: Logic Web Responsive Premium Template Designed for all web hosting providers
...
function setCookie(name,value,days) {
  ...
  function fillsbaseSettings({layout,color,background,font,header,radius,showSettings}){
  ...
  body = $('body');
  fillsbaseSettings.prototype.manageSettings = function(){
  ...
  fillsbaseSettings.prototype.manageHeader = function() {
    switch(this.header){
        case "static":
  ...
  fillsbaseSettings.prototype.manageLayout = function() {
    switch(this.layout){
        case "wide":
  ...
  fillsbaseSettings.prototype.manageColor = function() {
    switch(this.color){
        case "pink":
  ...
  fillsbaseSettings.prototype.manageBackground = function() {
...
fillsbaseSettings.prototype.manageRadius = function() {
    switch(this.radius){
        case "defaultradius":
...
fillsbaseSettings.prototype.manageFont = function() {
    switch(this.font){
        case "opensans":
            ...
            function getServicesInfo() {
                var info = {
                    VPS1: {
                        ...
                        price: "99.09",
                        priceon: "8.26",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=add&pid=4&carttpl=fillsbase"
                    },
                    VPS2: {
                        name: "Service B",
                        disk: "200GB",
                        ...
                        price: "155.00",
                        priceon: "12.92",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=add&pid=5&carttpl=fillsbase"
                    },
                    VPS3: {
                        name: "Service C",
                        disk: "300GB",
                        ...
                        price: "299.99",
                        priceon: "25.00",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=add&pid=6&carttpl=fillsbase"
                    },
                    VPS4: {
                        name: "Service D",
                        disk: "400GB",
                        ...
                        price: "395.22",
                        priceon: "32.94",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=confproduct&i=3&carttpl=fillsbase"
                    },
                    VPS5: {
                        name: "Service E",
                        disk: "500GB",
                        ...
                        price: "545.00",
                        priceon: "45.42",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=confproduct&i=4&carttpl=fillsbase"
                    }
                };
                return info;
            }
