...
<script>
/* Auto-submit confdomains when coming from our custom domain search (lw_autoconf flag) */
document.addEventListener('DOMContentLoaded', function() {
    var params = new URLSearchParams(window.location.search);
    // WHMCS forwards POST params into GET on redirect; check referrer too
    var fromSearch = params.get('lw_autoconf') === '1' ||
                     (document.referrer && document.referrer.indexOf('lw_autoconf=1') !== -1);
    if (fromSearch) {
        var form = document.getElementById('frmConfigureDomains');
        if (form) {
            // Brief delay so any WHMCS JS can finish initialising
            form.submit();
        }
    }
});
        ...
        <div class="header-lined">
            ...
            <div class="dropnav-header-lined">
                ...
                <div class="dropdown-menu bg-seccolorstyle" aria-labelledby="dropside-content">
                    {include file="orderforms/fillsbase/sidebar-categories.tpl"}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mt-50">
            <div class="sec-main bg-colorstyle sec-bg1 nopadding noshadow">
                ...
                <form method="post" action="{$smarty.server.PHP_SELF}?a=confdomains&lw_autoconf=1" id="frmConfigureDomains">
